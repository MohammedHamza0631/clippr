...
export default function GradientButton({ children, className, ...props }) {
  ...
  return (
    <button
      ...
      className={cn(
        'group relative w-fit flex px-12 py-4 rounded-lg bg-zinc-950 overflow-hidden shadow-[0px_1px_4px_0px_rgba(255,255,255,0.1)_inset,0px_-1px_4px_0px_rgba(255,255,255,0.1)_inset] text-white transition-all duration-300 hover:scale-[1.02]',
        className
      )}
      {...props}
    >
