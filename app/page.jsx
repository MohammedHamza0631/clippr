...
import { Activity, ArrowRight, BarChart3, Globe2, Link, Smartphone } from 'lucide-react'
...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Personalize your links with custom slugs for better branding',
    },
    {
  ...
  return (
    <main className="min-h-screen bg-[#030303]">
      ...
      <section className="relative">
        <HeroGeometric badge="Clippr" title1="Shorten Links" title2="Track Success" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-white/60 max-w-2xl mx-auto">
              Everything you need to create, manage, and analyze your shortened URLs in one place
            </p>
          </div>
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <p className="text-white/60 mb-8 max-w-2xl mx-auto">
            Join thousands of users who trust our platform for their URL shortening needs. Start
            tracking your link performance today.
          </p>
          <GradientButton onClick={() => router.push('/auth')} className="font-bold text-md">
            Get Started
