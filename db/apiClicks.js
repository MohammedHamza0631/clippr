...
import { IPAPI_GEO_URL, STORE_CLICK_DELAY_MS } from '@/lib/constants'
...
export const storeClicks = async ({ id, originalUrl }) => {
  try {
    ...
    let country = 'Unknown'
    try {
      const response = await fetch(IPAPI_GEO_URL)
    ...
    await new Promise((resolve) => setTimeout(resolve, STORE_CLICK_DELAY_MS))
